  ...
  render() {
    return (
      <div className='container'>
        ...
        <p>Ra 3 con giống nhau x 6 lần cược + trả lại vốn ban đầu đã cược </p>
        <p>Ra 2 con giống nhau x 4 lần cược + trả lại vốn ban đầu đã cược</p>
        <p>Ra 1 con giống nhau x 2 lần cược + trả lại vốn ban đầu đã cược</p>
